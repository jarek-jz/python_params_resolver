...
if __name__ == "__main__":
    ...
    pr = ParamsResolver()
    pr.register_fail_action(fail_action).add(
        "page-index",
        processors=(ExaminerIsIntString(), TransformerStringToInt()),
        optional=True,
        default="0",
    ).add(
        "page-size",
        ...
        "sort-col",
        processors=(
            ExaminerWrappedTest(is_valid_col_name, "Param %s has invalid value."),
        ),
        optional=True,
        default="id",
    ).add(
